            ...
            <div class="card mt-1">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label for="bayar">Customer bayar</label>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <label for="customer_bayar_hidden">Nilai Customer Bayar</label>
                                ...
                                <small class="text-muted">Status pembayaran akan ditentukan otomatis berdasarkan jumlah bayar</small>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-5" style="background-color: #E4E4F2; border-radius: 10px; padding: 20px;">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="harga" id="harga"
                                oninput="updateSubTotal()" readonly required>
                        </div>
                    </div>
                    <div class="col-9">
                        <div class="form-group">
            ...
            <div class="" style="margin-top: 40px">
                <div class="d-flex justify-content-between">
                    <button type="button" class="btn btn-primary" id="btn-tambah" onclick="tambahItem()">Tambah</button>
                    <a href="{{url('/kasir/list')}}" type="button" class="btn btn-info" id="btn-laporan">Laporan</a>
...
@section('script')
    <script>
        ...
        function hitungKembalian() {
            ...
            if (bayar > 0) {
                if (kembalian >= 0) {
                    ...
                    kembalianInput.value = `Kurang Rp ${formatRupiah(Math.abs(kembalian))}`;
                }
            } else {
            ...
            console.log('Calculation - Bayar:', bayar, 'Grand Total:', grandTotal, 'Kembalian:', kembalian, 'Customer Bayar:', customerBayarValue); // Debug
        }
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.status === 'success') {
                                ...
                                $(`#barang option[value="${barangId}"]`).attr('data-stok', response.stok);
                            }
                        },
                        error: function() {
        ...
        function resetForm() {
            ...
            // Reset form fields
            document.getElementById('costumer').value = '';
        ...
        $(document).ready(function() {
            $('#btn-simpan').on('click', function() {
                ...
                if (!costumer) {
                    alert('Silakan isi nama customer!');
                    return;
                }
