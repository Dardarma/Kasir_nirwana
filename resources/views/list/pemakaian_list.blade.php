...
@section('content')
                            ...
                            @foreach ($transaksi as $key => $item)
                                <tr>
                                    ...
                                    <td style="white-space: nowrap;">
                                        ...
                                        <form action="{{ route('pemakaian.destroy', $item->id) }}" method="POST" class="d-inline" onsubmit="return confirmDelete('{{ $item->kode_transaksi }}')">
                                            @csrf
                                            @method('PUT')
    ...
    @include('modaldetail.detail_pemakaian')
@endsection
@section('script')
    <script>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status === 'success' && response.data) {
                            ...
                            $('#detail-tanggal').text(new Date(response.transaksi.tanggal).toLocaleDateString('id-ID'));
