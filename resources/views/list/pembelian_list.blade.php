...
@section('content')
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-8">
                    <div class="d-flex justify-content-end align-items-center flex-wrap gap-2">
                        ...
                        <form method="GET" action="{{ url('/pembelian/list') }}" class="d-flex align-items-center gap-2">
                            <!-- Show entries -->
                        ...
                        <!-- Add Button -->
                        <a href="{{ url('/pembelian') }}" class="btn btn-primary btn-sm">
                            Transaksi Baru
                        </a>
                    </div>
                </div>
    ...
    @include('modaldetail.detail_pembelian')
@endsection
@section('script')
    <script>
        ...
        function confirmDelete(kodeTransaksi) {
            return confirm('Apakah Anda yakin ingin menghapus transaksi pembelian ' + kodeTransaksi +
